...
# Render (production) provides a single REDIS_URL; local dev uses separate
# REDIS_HOST / REDIS_PORT. Support both without needing different code per environment.
